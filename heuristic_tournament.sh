...
do
for WEIGHT_OF_FIRST_HEURISTIC in 1
do
for WEIGHT_OF_SECOND_HEURISTIC in 1 0
do
  ...
  for MAX_DEPTH2 in 5 10
  do
  for WEIGHT_OF_GAME_ORVER_SCORE2 in 0
  do
  for WEIGHT_OF_FIRST_HEURISTIC2 in 1
  do
  for WEIGHT_OF_SECOND_HEURISTIC2 in 0 1
  do
